...
public class PcloudyConnection {
            ...
            try {
                if (platform.equalsIgnoreCase("ios")) {
                    if (isTrustDevice) {
                        ...
                        appiumDriver = new IOSDriver<WebElement>(new URL(url), capabilities);
                    ...
                    appiumDriver = new AndroidDriver<WebElement>(new URL(url), capabilities);
    ...
    public void setCapability(String platform, String deviceName, String automationName, String applicationName, String androidActivity, String androidPackage, String deviceURL, String noReset) throws MalformedURLException {
        ...
        appiumDriver = new AndroidDriver(new URL(deviceURL), capabilities);
    }

    public static void launchApp(String bundleId, String app, By targetCompanyName, By trustCompanyName, By trustBtn) throws InterruptedException, MalformedURLException {
...
//        args.put("instrument", "noinstrument");
        appiumDriver.executeScript("mobile:installApp", args);
        System.out.println("app installed");
        trustDevice(targetCompanyName, trustCompanyName, trustBtn);
        args.put("bundleId", bundleId);
        appiumDriver.executeScript("mobile: launchApp", args);
        System.out.println("app launched");
        LOGGER.info("launch Application");
    }

    public static void reInstallApp(String bundleId, String app, By targetCompanyName, By trustCompanyName, By trustBtn) throws InterruptedException {
        LOGGER.info("terminate app");
        HashMap<String, Object> args = new HashMap<>();
        args.put("bundleId", bundleId);
        appiumDriver.executeScript("mobile: removeApp", args);
        LOGGER.info("Relaunch App");
        HashMap<String, Object> arg = new HashMap<>();
        arg.put("app", app);
        arg.put("bundleId", bundleId);
        appiumDriver.executeScript("mobile: installApp", arg);
        trustDevice(targetCompanyName, trustCompanyName, trustBtn);
        arg.put("bundleId", bundleId);
        appiumDriver.executeScript("mobile: launchApp", arg);
        System.out.println("app launched");
        LOGGER.info("launch Application");
    }

    public static void reInstallAppInResigned(String bundleId, String app) throws InterruptedException {
        LOGGER.info("terminate app");
        HashMap<String, Object> args = new HashMap<>();
        args.put("bundleId", bundleId);
        appiumDriver.executeScript("mobile: removeApp", args);
    ...
    public static void reStartAppAndroid() throws InterruptedException {
        LOGGER.info("terminate app");
        Thread.sleep(2000);
    ...
    public static void trustDevice(By targetCompanyName, By trustCompanyName, By trustBtn) throws InterruptedException {
        ...
        appiumDriver.activateApp("com.apple.Preferences");
        ...
        try {
            appiumDriver.findElement(targetCompanyName).click();
        } catch (Exception e) {
            appiumDriver.findElement(By.xpath("//XCUIElementTypeStaticText[@name='iPhone Distribution: i-exceed technology solutions private limited']")).click();
            LOGGER.info(e);
        }
        Thread.sleep(1000);
        try {
            appiumDriver.findElement(By.xpath("//XCUIElementTypeStaticText[@name='Trust “i-exceed technology solutions private limited”']")).click();
            Thread.sleep(2000);
        } catch (Exception e) {
            try{
                appiumDriver.findElement(trustCompanyName).click();
        ...
        try {
            appiumDriver.findElement(By.xpath("//XCUIElementTypeButton[@name='Trust']")).click();
            Thread.sleep(3000);
    ...
    public static void scrollClick(String name) {
        RemoteWebElement element = (RemoteWebElement) appiumDriver.findElement(By.xpath("//*[@name='" + name + "']"));
        ...
        if (appiumDriver == null) {
            ...
            try {
                if (platform.equalsIgnoreCase("ios")) {
                    ...
                    capabilities.setCapability("appPackage", androidPackage);
                    capabilities.setCapability("appActivity", androidActivity);
                    appiumDriver = new AndroidDriver<WebElement>(new URL("https://device.pcloudy.com/appiumcloud/wd/hub"), capabilities);
                    LOGGER.info("Android Driver connected");
                }
            } catch (Exception e) {
                LOGGER.info("Devices not available : " + e);
